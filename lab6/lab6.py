...
# LAB 6 - rozwiazanie
    ...
    parametersCollapsibleButton1.text = "New parameters"
    ...
    parametersFormLayout1.addRow("Input Volume: ", self.inputSelector1)
    ...
    self.imageThresholdSliderWidget1.maximum = 100
    self.imageThresholdSliderWidget1.value = 50
    ...
    parametersFormLayout1.addRow("Image opacity", self.imageThresholdSliderWidget1)

    #
    # Apply Button
    #
    self.Button = qt.QPushButton("Hide/show model")
    self.Button.toolTip = "Run the algorithm."
    self.Button.enabled = False
    parametersFormLayout1.addRow(self.Button)
  ...
  # connections
    ...
    self.inputSelector1.connect("currentNodeChanged(vtkMRMLNode*)", self.onSelect1)
  ...
  def onSelect1(self):
    self.Button.enabled = self.inputSelector1.currentNode()
  ...
  def onButton(self):
    logic = lab6Logic()
    enableScreenshotsFlag = self.enableScreenshotsFlagCheckBox.checked
    imageOpacity = self.imageThresholdSliderWidget1.value
    logic.run(self.inputSelector1.currentNode(), self.outputSelector.currentNode(), imageOpacity, enableScreenshotsFlag,2)
